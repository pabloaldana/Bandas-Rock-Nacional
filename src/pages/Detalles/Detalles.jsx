  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex h-auto bg-black">
        <div className="flex-1 "></div> {/* Este div ocupa 3/4 de la pantalla */}
        <div className="flex-1/4   items-center"> {/* Este div ocupa 1/4 de la pantalla */}
          <Button contentRef={contentRef} text="Guardar como PDF" onClick={handleGuardarComoPDF} />
          <Button contentRef={contentRef} text="Imprimir" onClick={handlePrint} />
        </div>
      </div>
      <div className="flex h-auto" ref={pdfContainerRef}>
        <div
          ref={contentRef}
          className="flex-grow bg-cover bg-center bg-[url(https://img.freepik.com/foto-gratis/fondo-habitacion-vacia-digital-futurista-moderno_1409-4974.jpg?t=st=1715221324~exp=1715224924~hmac=a3357bc105194ac1674eec79ac09d42f06c6a8567e07045c97f35b0f2edebe78&w=1380)]"
        >
          {banda && (
            <div className="mt-4 ">
              <h1 className="font-sans underline text-5xl text-white text-center ">
                {banda.name}
              </h1>
              ...
              <div className="mt-5 py-5">
                {banda.integrantes && (
                  <div>
                    <h2 className="text-white text-3xl font-sans text-center">Integrantes</h2>
              ...
              <div id="discografia" className="mb-5 mt-2 text-center">
              ...
              <div className="mb-5 mt-5 pb-5 border-t-2">
                <h3 className="text-white text-3xl mt-2 text-center">Galería</h3>
                <div className="flex flex-wrap justify-center">
              ...
              {imagenExpandida && (
                ...
                >
                  <img
                    ...
                    className="w-auto h-3/5 backdrop-blur"
                  />
                </div>
              )}
            </div>
